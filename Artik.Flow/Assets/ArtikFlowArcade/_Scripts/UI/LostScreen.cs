...
public class LostScreen : ILostScreen
{
	...
	void OnEnable()
	{
        ...
        transform.Find("Button_Play").GetComponent<TweenScale>().enabled = true;
		transform.Find("Button_Play").GetComponent<TweenScale>().ResetToBeginning();
